  ...
  return(
    <div className="min-h-screen flex flex-col" >
      ...
      items-center justify-around flex-shrink-0 " >
        ...
        <button className="py-1 px-2 bg-indigo-800
        hover:bg-indigo-600 active:bg-indigo-600
        rounded-md " >
          Contact me</button>
      ...
      font-smooth " >
        <p className="sm:w-3/4 md:w-3/5
               lg:w-2/5 font-semibold font-sans"
         >I'm a web developer.<br></br>
        I develop mobile-friendly and responsive site and web apps<br/>
      ...
      <footer className="text-white flex h-24 
      items-center justify-center flex-shrink-0 " >
        <button className="py-1 px-2 bg-indigo-800
        hover:bg-indigo-600 active:bg-indigo-600
        rounded-md " >Send me email</button>
      </footer>
    </div>
