  ...
  return(
    ...
    style={{fontFamily: "newadobe"}} >
      ...
      items-center justify-around flex-shrink-0 " >
        ...
        <div className=" flex w-1/2 md:w-1/4 justify-around 
        md:justify-between "  >
        ...
        <a href="https://twitter.com/theabdulaimusah" 
        target="blank"
        className="block"
        >
          <svg
  ...
  <span class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500
   ...
   style={{fontFamily: "mysoul"}}  >
    ...
    Abdulai Musah
        ...
        <p className="sm:w-2/3 md:w-3/5 p-4 pr-8
               lg:w-1/2 font-normal text-lg overflow-hidden">
            <p className="overflow-hidden slidetext pr-8 ">
